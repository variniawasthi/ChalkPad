...
import { setElement } from "../Redux/reducers/elementSlice";
      ...
      case 1:
        {
          ...
          if (roomId != null) {
            GlobalProps.socket.emit("render-elements", {
              tempNewArray,
              roomId,
              key,
            });
    ...
    if (type === "rectangle" || type === "ellipse" || type === "diamond") {
      ...
      if (
        ...
        if (distance(minX, minY, cx, cy) < 12 / scale) {
          ...
          distance(minX, minY + (maxY - minY) / 2, cx, cy) <
          12 / scale
        ) {
          // left mid
          // console.log("left mid");
          ...
          distance(maxX, minY + (maxY - minY) / 2, cx, cy) <
          12 / scale
        ) {
          // right mid
          // console.log("right mid");
          ...
          distance(minX + (maxX - minX) / 2, minY, cx, cy) <
          12 / scale
        ) {
          // top mid
          // console.log("top mid");
          ...
          distance(minX + (maxX - minX) / 2, maxY, cx, cy) <
          12 / scale
        ) {
          // bottom mid
          // console.log("bottom mid");
