...
import { setCopyElement, setSelectedElement } from '../Redux/reducers/selectedElementSlice';
import { setAction } from '../Redux/reducers/actionSlice';
import { addElementToInventory, updateElement } from '../ElementManipulation/Element';
    ...
    const handler = (event) => {
      ...
      if (event.key === '1') {
        ...
        if (copyElement != null) {
          ...
          addElementToInventory(elements, null, null, null, null, copyElement, mouseEvent);
        ...
        if (selectedElement != null) {
          const getElementFromInventory = elements[parseInt(selectedElement.id.split("#")[1])];
          addElementToInventory(elements, null, null, null, null, getElementFromInventory);
          store.dispatch(changeTool("selection"));
        }
      }
